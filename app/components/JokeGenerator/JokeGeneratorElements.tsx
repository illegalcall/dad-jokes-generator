...
export const JokeGeneratorCon = styled.div`
	min-height: 350px;
	min-width: 350px;
	height: 70vh;
	width: 70vw;
...
export const JokeGeneratorInnerCon = styled.div`
	top: 50%;
	left: 50%;
	transform: translate(-50%, -50%);
	position: absolute;
...
export const GenerateJokeButton = styled.div`
	height: 100px;
	width: 300px;
...
export const JokeGeneratorModalCon = styled(Box)`
	position: absolute;
	top: 50%;
	left: 50%;
	transform: translate(-50%, -50%);
...
export const ModalCircularProgress = styled(
	CircularProgress
)`
