...
export default function JokeAppDataCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setJokesGenerated(initialValues.jokesGenerated);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new JokeAppData(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "JokeAppDataCreateForm")}
      {...rest}
    >
      <TextField
        label="Query name"
